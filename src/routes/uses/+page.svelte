...
<svelte:head>
	...
	<meta name="title" content="What I use - Bhavya Muni" />
	<meta name="description" content="The hardware, software, and tools Bhavya Muni uses day to day." />
</svelte:head>

<div class="flex flex-row justify-start items-center">
	<a href="/" aria-label="Home"><i class="fas fa-chevron-left" /></a>
	<div class="w-2" />
	<h1 class="font-semibold text-3xl">Uses 🛠️</h1>
</div>
<p />
